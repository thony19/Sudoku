...
document.getElementById('btn-level').addEventListener('click', (e) => {
    ...
    setTimeout(() => {
        btnLevel.classList.remove('btn-level');
    }, 500);
});
...
document.getElementById('btn-play').addEventListener('click', () => {
    ...
    lottie.classList.add('displayNone')
    lottie_two.classList.add('displayNone')
    // start_screen.classList.toggle('active')
    // game_screen.classList.toggle('active')
});
document.getElementById('game-back').addEventListener('click', () => {
    start_screen.classList.toggle('active')
    game_screen.classList.toggle('active')
    lottie.classList.remove('displayNone')
    lottie_two.classList.remove('displayNone')
    pause = false;
    clearInterval(timer);
});
...
document.getElementById('nav-logo').addEventListener('click', ()=>{
    if( start_screen.className != 'start-screen active' ){
        start_screen.classList.toggle('active')
        game_screen.classList.toggle('active')
